...
$keyword = 'Digital Niche Design';
$canonical = "https://logicworks.ae/digital-niche-design";
...
<style>
    ...
    .digital-niche-design .section-marquee .marwuee-row:before {
        display: none;
    }
</style>
<main class="digital-niche-design">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-white">Design that fits your <span>niche—and sells.</span> </h1>
                    <p class="text-logo text-start">We craft conversion‑focused websites tailored to your niche’s
                        language,<br>
                ...
                <div class="col-lg-4">
                    <img src="assests/images/digital-niche-design/hero-image.webp" alt="digital-hero-banner">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">No templates. 100% custom strategy + design &nbsp;—&nbsp;No
                                    templates. 100% custom strategy + design</p>
                            </div>
                            <span class="marquee__separator"><img src="assests/images/service/Star.webp"></span>
                            <div class="marquee__item">
                                <p class="marquee__text">No templates. 100% custom strategy + design </p>
                            </div>
                            <span class="marquee__separator"><img src="assests/images/service/Star.webp"></span>
                            <div class="marquee__item">
                                <p class="marquee__text">No templates. 100% custom strategy + design</p>
    ...
    <section>
        <?php
        include("components/digital-why.php");
        ?>
    </section>
    <section>
        <?php
        include("components/digital-right-desing.php");
        ?>
    </section>
    <section>
        <?php
        include("components/digital-niche-slider.php");
        ?>
    </section>
    <section>
        <?php
        include("components/prof-that-niche.php");
        ?>
    </section>
    <section>
        <?php
        include("components/adult-to-launch-slider.php");
        ?>
    </section>
    <!-- Ask any Q -->

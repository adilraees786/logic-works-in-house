<?php
$meta_title = "Facebook Instagram temporary";
...
<main class="facebook-instagram-marketing-dubai bg-black">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-sm-6">
                    <h1 class="text-white mb-20"><span class="small-text fs-30 fw-700">Skyrocket Your Sales with</span>
                        Facebook & INSTAGRAM ADS IN DUBAI </h1>
                    <h2 class="text-white fs-22 mb-20 fw-700">Expert Meta Ad Strategies to Generate More Leads,
                        Conversions & <br> Revenue for Your Business.</h2>
                    <p class="text-white fs-18">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                ...
                <div class="col-lg-4 col-sm-6">
                    <img src="assests/images/fb-insta-ads/hero-img.webp" class="" style="">
                </div>
            </div>
    ...
    <section class="twod-animation-service section-bg pb-100"
        style="background-image: url(assests/images/fb-insta-ads/slider-bg.webp); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 100px; ">

        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="fb-heading text-center fs-62 fw-900 text-white">
                        Our Facebook & Instagram <br> Services
                    </h2>
                    <p class="text-white fs-25 text-center mb-50">
                        Why Dubai’s Top Brands Trust Us for Social Media Ads
                    </p>
                </div>
                <div class="row twod-animation-service-slider">
                    <div class="col-lg-4">
                        <div class="td-animation-wcu-card td-animation-service-card ">
                            <img src="assests/images/fb-insta-ads/img-1.webp" class="" alt="">
                            <div class="td-animation-service-card-bottom-content py-30 px-20">
                                <h4 class="fw-700 fs-24 text-primary-theme">Lead Generation Ads</h4>
                                <p class="fs-13 mb-20">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore
                                    et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                                    laboris nisi ut
                                    aliquip ex ea commodo consequat.... <a href="#" class="text-primary-theme">Read
                                        More</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="td-animation-wcu-card td-animation-service-card  ">
                            <img src="assests/images/fb-insta-ads/img-2.webp" class="" alt="">
                            <div class="td-animation-service-card-bottom-content py-20 px-20">
                                <h4 class="fw-700 fs-24 text-primary-theme">Facebook & Instagram Ad Management</h4>
                                <p class="fs-13 mb-20">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore
                                    et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                    ...
                    <div class="col-lg-4">
                        <div class="td-animation-wcu-card td-animation-service-card  ">
                            <img src="assests/images/fb-insta-ads/img-3.webp" class="" alt="">
                            <div class="td-animation-service-card-bottom-content py-30 px-20">
                                <h4 class="fw-700 fs-24 text-primary-theme">Reels & Video Ads</h4>
                                <p class="fs-13 mb-20">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore
                                    et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
    ...
    <section class="section-bg web-dev-pag mt-100" id="transform-app">
        <div class="container" style="display: block; max-width: 100%;">
            <div class="row align-items-center transform-row">
                ...
                <div class="col-lg-8">
                    <h2 class="text-white same-all text-start">Not Sure About Your Ads?<br> Get a Free Audit!</h2>

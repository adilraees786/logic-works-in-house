...
<style>
    ...
    .mobile-app-development-company-qatar .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .mobile-app-development-company-qatar .section-marquee .marwuee-row:before {
        display: none;
    }

    .mobile-app-development-company-qatar .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="mobile-app-development-company-qatar bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <img src="./assests/images/app-development-niche-design/Qatar-app.webp" alt="app-dev-niche-hero-img">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Mobile App Development Company Qatar
                                    &nbsp;—&nbsp;Mobile App Development Company Qatar
                                </p>
                            </div>
    ...
    <section>
        <?php
        include("components/qatar-mobile-app-about.php");
        ?>
    </section>
...
<style>
    ...
    .mobile-app-development-company-qatar .consultancy-hero-sec .col-lg-4 {
        display: flex;

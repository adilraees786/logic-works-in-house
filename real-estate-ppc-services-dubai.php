<?php
$meta_title = "Android App Development Dubai | Custom Mobile Solutions by Logic Works";
...
$keyword = 'PPC Niche Design';
$canonical = "https://logicworks.ae/ppc-niche-design";
...
<style>
    ...
    .ppc-btn {
        background: linear-gradient(90deg, #9441EB 0%, #F67B80 100%);
        padding: 5px 10px;
        color: white;
        border-radius: 10px;
        font-size: 20px;
    ...
    .ppc-niche-design .ppc-btn:hover {
        background: white;
        color: #9441EB;
        font-weight: 500;
...
<main class="ppc-niche-design bg-black">
    <section class="consultancy-hero-sec section-bg"
        style="background-image: url('assests/images/PPC-Niche-Design/hero-bg.webp'); background-size: cover; background-position: center; background-repeat: no-repeat;">

        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-8">
                    <h1 class="text-white">Get More Leads With <span>Smarter PPC Campaigns </span></h1>
                    <p class="text-logo">Drive targeted traffic,Z lower costs, and boost <br> conversions with
                        data-driven
                        PPC management.</p>
    ...
    <section class="discuss-sec section-bg">
        <div class="container">
            <div class="row dubai-row-mind align-items-center mt-0"
                ...
                <div class="col-lg-4">
                    <img src="assests/images/PPC-Niche-Design/ready-left-img.webp" alt="ppc-cta-img"
                        class="dubai-agent">
                </div>
                <div class="col-lg-8">
                    <h2 class="text-white same-all mb-0">Ready to Scale Your <span>Business with PPC? </span> </h2>
                    <p class="text-white">Don’t waste another dollar on ads that don’t convert. <br> Let’s build a
                        smarter, results-driven PPC
                        strategy for you <br> — starting today.</p>
                    <button class="ppc-btn">Get My Free PPC Audit Now</button>
                </div>
            </div>
        </div>
    </section>

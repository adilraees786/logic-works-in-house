...
?>
<style>
    .retail-app-development-company-dubai {
        overflow: hidden;
    }

    .retail-app-development-company-dubai .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .retail-app-development-company-dubai .section-marquee .marwuee-row:before {
        display: none;
    }

    .retail-app-development-company-dubai .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="retail-app-development-company-dubai bg-black">
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Retail App Development Company Dubai
                                    &nbsp;—&nbsp;Retail App Development Company Dubai
                                </p>
                            </div>
    ...
    <section>
        <?php
        include("components/retail-app-about-dubai.php");
        ?>
    </section>
    ...
    <section class="section-bg app-dubai-services">
        <div class="container">
            <div class="row dubai-tabs-row">
                <div class="col-lg-6">
                    <img src="./assests/images/Retail-App/tab-image.webp" alt="retail-app-dev-img">
                </div>
                <div class="col-lg-6">
...
<style>
    ...
    .retail-app-development-company-dubai .consultancy-hero-sec .col-lg-4 {
        display: flex;

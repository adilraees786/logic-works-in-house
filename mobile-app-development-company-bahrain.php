<?php
$meta_title = "Mobile App Development Company Bahrain | Logic Works ";
...
<style>
    ...
    .mobile-app-development-company-bahrain .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .mobile-app-development-company-bahrain .section-marquee .marwuee-row:before {
        display: none;
    }

    .mobile-app-development-company-bahrain .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="mobile-app-development-company-bahrain bg-black">
    ...
    <section>
        <?php
        include("components/bahrain-mobile-app-about.php");
        ?>
    </section>

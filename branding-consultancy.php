<?php
$meta_title = "Branding Consultancy temper";
...
$keyword = 'Branding Consultancy tem';
...
<main class="branding-consultancy bg-black">
    <section class="blur-bg section-bg digital-main" id="portfolio-hero"
        style="background-image: url('assests/images/branding-consultancy/hero-bg.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover; padding-top: 40px; padding-bottom: 60px;">

        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white-hero-1">Transform Your Brand Elevate <br> Your Business!</h1>
                    <p class="text-white-hero">We help businesses build powerful brands with strategic <br> positioning,
    ...
    <section class="bg-black"
        style="background-image: url('assests/images/serice-bg.png'); background-position: center; background-size: cover; background-repeat: no-repeat; padding-top: 80px;">
        <?php
    ...
    <!-- <div
        ...
        <section class="section-bg web-dev-pag mt-100"
            style="background-image: url(assests/images/social-media-marketing-dubai/bg-image.png);" id="transform-app">
            <div class="container" style="display: block; max-width: 100%;">
                <div class="row align-items-center transform-row">
                    ...
                    <div class="col-lg-8">
                        <h2 class="text-white same-all text-start pt-30">Not Sure About Your Ads?<br> Get a Free Audit!
                        </h2>

...
?>
<style>
    .mobile-app-development-company-saudia-arabia {
        overflow: hidden;
    }

    .mobile-app-development-company-saudia-arabia .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .mobile-app-development-company-saudia-arabia .section-marquee .marwuee-row:before {
        display: none;
    }

    .mobile-app-development-company-saudia-arabia .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="mobile-app-development-company-saudia-arabia bg-black">
    ...
    <section>
        <?php
        include("components/saudia-arabia-mobile-app-about.php");
        ?>
    </section>

<?php
$meta_title = "Logo design Niche temporary";
...
$keyword = 'Logo Design Niche';
$canonical = "http://localhost//logic-works/real-estate-logo-design-dubai";
...
<style>
    ...
    .logo-design-niche .consultancy-hero-sec .col-lg-4 img {
        min-width: 400px;
    }

    .logo-design-niche .consultancy-hero-sec .col-lg-4 {
        display: flex;
...
<main class="logo-design-niche bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-12">
                    <h1 class="text-white">Logo Design <span>That Builds Lasting Brands</span>
                    </h1>
                    <p class="text-logo">Your logo is more than a symbol — it’s the face of your business. At Logic
                        Works, we craft logos that capture your identity, connect with your audience, and stand the test
                        of time.</p>
                ...
                <div class="col-lg-4 col-md-4">
                    <img src="assests/images/Logo-design-niche/hero-img.webp" alt="logo-design-hero-img">
                </div>
            </div>
        </div>
    </section>
    <section>
        <?php
        include("components/why-logo-design.php");
        ?>
    </section>
    <section class="">
        <?php
        include("components/logo-creative-process.php");
        ?>
    </section>
    <section class="mt-40">
        <?php
        include("components/logo-design-slider.php");
        ?>
    </section>
    <section class="">
        <?php
        include("components/logo-design-process.php");
        ?>
    </section>
    <section class="">
        ...
        <div class="row align-items-center transform-row">
            <div class="col-lg-4">
                <img src="assests/images/marketing/banda.webp" alt="logo-design-banda" class="gta">
            </div>
            <div class="col-lg-8">

<?php
$meta_title = "Website Designer Temper";
...
<main class="website-designer bg-black">
    <section class="blur-bg section-bg digital-main" id="portfolio-hero"
        style="background-image: url('assests/images/website-designer/web-hero-bg.png'); background-repeat: no-repeat; background-position: center; background-size: cover; padding-top: 40px; padding-bottom: 60px;">

        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white-hero-11">Beautiful, Responsive <br> Websites Designed to <br> Convert</h1>
                    <p class="text-white-hero-1">Crafting custom websites that are fast, mobile-friendly, <br> and
                        designed
    ...
    <section class="discuss-sec pb-100 section-bg">
        <div class="container">
            <div class="row dubai-row-mind align-items-center"
                style="background-image: url('assests/images/website-designer/descoimg.jpg')">
                <div class="col-lg-4">
                    <img src="assests/images/android-app-development/laptop.png" class="dubai-agent">
                </div>
                <div class="col-lg-8">
    ...
    <section class="choice-sectio-web-designer bg-black">
        ...
        <div>
            <div class="row text-center mb-5"
                style="background-image: url(assests/images/website-designer/slider-bg-img.jpg); background-repeat: no-repeat; background-position: center; background-size: cover; padding-top: 40px; padding-bottom: 150px;">
                <div class="col-12">
                    <h2 class="text-white fw-bold display-4 mt">Featured Services</h2>
                    <p class="text-white fs-5 mb-5">Website Design Services Tailored for You</p>
                </div>
            </div>
                        ...
                        <div class="row twod-animation-service-slider">
                            <div class="col-lg-4">
                                <div class="td-animation-wcu-card td-animation-service-card  ">
                                    <img src="assests/images/website-designer/slider-img-1.png" class="" alt="">
                                    <div class="td-animation-service-card-bottom-content py-30 px-20">
                                        <h4 class="fw-700 fs-20 text-primary-theme">Custom WordPress Development
                                        </h4>
                                        <p class="fs-13">
                            ...
                            <div class="col-lg-4">
                                <div class="td-animation-wcu-card td-animation-service-card  ">
                                    <img src="assests/images/website-designer/slider-img-3.png" class="" alt="">
                                    <div class="td-animation-service-card-bottom-content py-30 px-20">
                                        <h4 class="fw-700 fs-24 text-primary-theme">UI/UX Web Design</h4>
                                        <p class="fs-13">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor
                                            incididunt ut labore
                            ...
                            <div class="col-lg-4">
                                <div class="td-animation-wcu-card td-animation-service-card  ">
                                    <img src="assests/images/website-designer/slider-img-3.png" class="" alt="">
                                    <div class="td-animation-service-card-bottom-content py-30 px-20">
                                        <h4 class="fw-700 fs-24 text-primary-theme">E-commerce Website Design</h4>
                                        <p class="fs-13">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor
                                            incididunt ut labore
                            ...
                            <div class="col-lg-4">
                                <div class="td-animation-wcu-card td-animation-service-card  ">
                                    <img src="assests/images/website-designer/slider-img-2.png" class="" alt="">
                                    <div class="td-animation-service-card-bottom-content py-30 px-20">
                                        <h4 class="fw-700 fs-24 text-primary-theme">UI/UX Web Design</h4>
                                        <p class="fs-13">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
    ...
    <section class="about-ads py-100 section-bg">
        <div class="row align-items-center mt-0 transform-row about-ads-bg">
            ...
            <div class="col-lg-8">
                <h2 class="text-white fs-47 fw-900 text-end ">We have transformed 8000+ <br>
                    business with our Development
                    <br> Expertise
                </h2>
...
<style>
 ...
 .website-designer .section-bg {
    ...
    .website-designer .about-ads-bg {
        background: url('assests/images/website-designer/banda-bg.jpg') no-repeat center/cover;
        position: relative;
        z-index: 1;

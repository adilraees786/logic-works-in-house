        ...
        <div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-lg-3 text-center mb-4 mb-lg-0">
                    <img src="assests/images/android-app-service/android.webp" alt="Android" class="android-img" />
                </div>

                <!-- Side Cards -->
                <div class="col-lg-5">
                    <div class="side-card" onclick="updateMainCard(0)">
                        <img src="assests/images/android-app-service/android-4.webp" alt="android-image-1" />
                    ...
                    <div class="side-card" onclick="updateMainCard(1)">
                        <img src="assests/images/android-app-service/android-2.webp" alt="android-image-2" />
                        <div class="side-card-body">
                    ...
                    <div class="side-card" onclick="updateMainCard(2)">
                        <img src="assests/images/android-app-service/android-3.webp" alt="android-image-3" />
                        <div class="side-card-body">
                ...
                <div class="col-lg-4">
                    <div class="main-card" id="mainCard">
                        <img src="assests/images/android-app-service/android-4.webp" id="mainCardImg" alt="Main" />
        ...
        const services = [
            {
                ...
                img: "assests/images/android-app-service/android-1.webp"
            },
            {
                title: "Open-source flexibility",
                text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.",
                img: "assests/images/android-app-service/android-2.webp"
            },
            {
                title: "Cost-effective & high ROI",
                text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.",
                img: src = "assests/images/android-app-service/android-3.webp"
            }
        ];

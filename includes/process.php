            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="process-image">
                        <img id="processImage" src="assests/images/ai-development/Group1.webp" alt="Process Image"
                    ...
                    <div class="process-tabs">
                        ...
                        <div class="tab-item" data-tab="deployment">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="tab-title">Deployment and Integration</h4>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    const tabData = {
        discovery: {
            image: 'assests/images/ai-development/process-img-1.webp',

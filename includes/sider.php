...
<body>
  <div class="container d-block">
    <div class="">
      <h2 class="main-title">OUR ANDROID APP DEVELOPMENT SERVICES</h2>
      <div class="subtitle">Built to Solve Problems, Not Just Add Features</div>
    </div>
    <div class="row">
      <div class="col-lg-6">
        <!-- Main Card (left) -->
        <div class="main-card" id="mainCard">
          <img src="assests/images/android-app-development/left1.webp" id="mainCardImg" alt="Service Image">
          <div class="main-card-body">
            <div class="main-card-title" id="mainCardTitle">Custom Android App Development</div>
            <div class="main-card-text" id="mainCardText">
              We build apps around your goals, solving user issues with clear features and smooth performance.
            </div>
    ...
    const services = [
      {
        ...
        img: "assests/images/android-app-development/left1.webp",
        btn: "READ MORE",
        text: "We build apps around your goals, solving user issues with clear features and smooth performance. "
      },
      {
        title: "UI/UX Design",
        img: "assests/images/android-app-development/left2.webp",
        btn: "READ MORE",
        text: "Simple layouts, easy flows, and design choices that help users stay, interact, and complete tasks."
      },
      {
        title: "App Testing & QA",
        img: "assests/images/android-app-development/left3.webp",
        btn: "READ MORE",
        text: "Every screen, tap, and function is checked across devices to fix bugs before your users do."
      },
      {
        title: "App Maintenance & Support",
        img: "assests/images/android-app-development/left1.webp",
        btn: "READ MORE",
        text: " We keep your app updated, stable, and ready for changes—long after it goes live."
      },
      {
        title: "App Migration & Upgrades",
        img: "assests/images/android-app-development/left2.webp",
        btn: "READ MORE",
        text: "Old apps are rebuilt, modernized, and improved for new devices, better speed, and cleaner performance."
      }
    ];

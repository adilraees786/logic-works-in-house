...
<body>
  <div class="container d-block">
    <div class="">
      <h1 class="main-title">OUR ANDROID APP <br> DEVELOPMENT SERVICES</h1>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="main-card" id="mainCard">
          <img src="assests/images/android-app-development/left1.png" id="mainCardImg" alt="Service Image">

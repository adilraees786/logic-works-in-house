...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $base_url; ?>assests/css/utilities.css" />
  <link rel="stylesheet" href="<?php echo $base_url; ?>assests/css/style.css" />
  <link rel="stylesheet" href="<?php echo $base_url; ?>assests/css/service.css">
  <link rel="stylesheet" href="<?php echo $base_url; ?>assests/css/responsive.css" />
  <!-- Theme Custom CSS -->
  <link rel="stylesheet" href="<?php echo $base_url; ?>frisk/assets/css/style.css">
  <!-- Slider Css -->
  ...
  <style>
    ...
    .log-bef:before {
      content: '';
      position: absolute;
      background: url(frisk/assets/img/header-1.webp);
      width: 709px;
      height: 865px;
      background-size: 97%;
      left: auto;
    ...
    .servicess-section {
      background-image: url(<?php echo $base_url; ?>assests/images/serice-bg.webp);
    ...
    .project-in-mind a:before {
      content: '';
      position: absolute;
      background: url(<?php echo $base_url; ?>assests/images/right-arrow-mind.png) no-repeat;
      width: 68px;
      height: 68px;
      right: -2%;
      margin-top: -15px;
    ...
    #project-in-minds .main-tow-btn a:before {
      background: url(<?php echo $base_url; ?>assests/images/phon-icon.webp) no-repeat;
    }

    .quwstion .panel ul li:before {
      content: '';
      position: absolute;
      background: url(<?php echo $base_url; ?>assests/images/arrow-icon.webp) no-repeat;
      width: 13px;
      height: 14px;
      margin-left: -17px;
      margin-top: 5px;
    ...
    .industries-slider .swiper-pagination span.swiper-pagination-bullet:nth-child(1) {
      background: url(<?php echo $base_url; ?>assests/images/health-pagi.png) no-repeat;
    }

    .industries-slider .swiper-pagination span.swiper-pagination-bullet:nth-child(2) {
      background: url(<?php echo $base_url; ?>assests/images/ecommerce.png) no-repeat;
    }

    .industries-slider .swiper-pagination span.swiper-pagination-bullet:nth-child(3) {
      background: url(<?php echo $base_url; ?>assests/images/digital.png) no-repeat;
    }

    .industries-slider .swiper-pagination span.swiper-pagination-bullet:nth-child(4) {
      background: url(<?php echo $base_url; ?>assests/images/travel-transport.webp) no-repeat;
    }

    .industries-slider .swiper-button-prev:after {
      content: '';
      background: url(<?php echo $base_url; ?>assests/images/arrow-left.webp) no-repeat;
      width: 73px;
      height: 54px;
    }
    ...
    .industries-slider .swiper-button-next:after {
      content: '';
      background: url(<?php echo $base_url; ?>assests/images/arrow-right.webp);
      width: 73px;
      height: 54px;
    }

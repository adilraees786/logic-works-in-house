...
<head>
    ...
    <!-- Optional: Bootstrap Icons for arrows -->
...
<body class="bg-dark text-white">
    ...
    <div class="container py-5">
        <div>
            ...
            <p class="lead-para text-center mb-4">See How We've Built Next-Gen Apps</p>
    ...
    <script>
        const slides = [
            {
                img:  src="assests/images/app-development-technology/img1.png",
            ...
            {
               img:  src="assests/images/app-development-technology/img2.png",
                title: "Healthcare Web App:",
                desc: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s..... Read More"
            },
            {
     img:  src="assests/images/app-development-technology/img3.png",

<?php
$meta_title = "AI for Business Automation | Logic Works";
...
?>
<style>
    .ai-for-business-automation-page .section-marquee .marwuee-row:before {
        display: none;
    }
</style>
<main class="ai-for-business-automation-page bg-black">
    <section class="consultancy-hero-sec section-bg"
        style="background-image: url('assests/images/ai-for-business-automation/ai-hero-bg.webp'); background-size: cover; background-position: center; background-repeat: no-repeat;">

        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-12">
                    <h1 class="text-white">Smarter Business. Faster <span>Growth</span> Powered by AI.</h1>
                    <p class="text-white">At Logic Works, we help companies streamline operations, reduce costs, and
                        boost efficiency with cutting-edge AI solutions designed for business automation.</p>
    ...
    <section>
        <?php
        include("components/what-is-business-auto.php");
        ?>
    </section>
    <section>
        <?php
        include("components/ai-how-we-work.php");
        ?>
    </section>
    <section>
        <?php
        include("components/why-ai-business-matter.php");
        ?>
    </section>
    <section>
        <?php
        include("components/ai-business-capability.php");
        ?>
    </section>
        ...
        <div class="bg-white-heading-custom">
            <div class="container">
                <div class="row white-bg-heading-custom-row">
                    <div class="col-md-12">
                        <h2 class="section-title text-center">Questionnaire<span>Section</span></h2>
                    </div>
                </div>
            </div>
        </div>

<?php
$meta_title = "Mobile App Development Company UAE | Logic Works ";
    ...
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white">Mobile App Development <span>Company UAE</span></span>
                    </h1>
                ...
                <div class="col-lg-4">
                    <img src="./assests/images/mobile-app-development-company-uae/hero-img.webp" alt="app-Uae-niche-hero-img">
                </div>
            </div>
        </div>
    </section>

<?php
$meta_title = "Android Education App Development Company | Logic Works";
...
$canonical = "https://logicworks.ae/android-education-app-development-company";
...
<style>
    ...
    .android-education-app-development-company .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .android-education-app-development-company .section-marquee .marwuee-row:before {
        display: none;
    }

    .android-education-app-development-company .same-all {
        font-size: 50px;
        font-weight: 600;
    }
...
<main class="android-education-app-development-company bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white">Android <span>Education App</span> Development Company</span>
                    </h1>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Android Education App Development Company
                                    &nbsp;—&nbsp;Android Education App Development Company
                                </p>
                            </div>
    ...
    <section>
        <?php
        include("components/education-app-about.php");
        ?>
    </section>

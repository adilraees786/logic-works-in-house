<?php
$meta_title = "Android Finance App Development Company | Logic Works ";
...
$keyword = 'Android Finance App Development Company';
...
?>
<style>
    .android-finance-app-development-company {
        overflow: hidden;
    }

    .android-finance-app-development-company .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .android-finance-app-development-company .section-marquee .marwuee-row:before {
        display: none;
    }

    .android-finance-app-development-company .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="android-finance-app-development-company bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white">Android <span>Finance App</span> Development Company </span>
                    </h1>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Android Finance App Development Company
                                    &nbsp;—&nbsp;Android Finance App Development Company
                                </p>
                            </div>
    ...
    <section>
        <?php
        include("components/finance-app-about.php");
        ?>
    </section>
    ...
    <section class="section-bg app-dubai-services">
        <div class="container">
            <div class="row dubai-tabs-row">
                <div class="col-lg-6">
                    <img src="assests/images/android-finance-app-development-company/service-finance-img.webp" alt="finance-img-app-dev">
                </div>
                <div class="col-lg-6">
...
<style>
    ...
    .android-finance-app-development-company .consultancy-hero-sec .col-lg-4 {
        display: flex;

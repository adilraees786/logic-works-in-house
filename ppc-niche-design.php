...
<main class="ppc-niche-design bg-black">
    <section class="consultancy-hero-sec section-bg"
        style="background-image: url('assests/images/PPC-Niche-Design/hero-img.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    ...
    <section class="discuss-sec pb-100 section-bg">
        <div class="container">
            <div class="row dubai-row-mind align-items-center mt-0"
                style="background-color: #141414; border-radius: 30px;">
                <div class="col-lg-4">
                    <img src="assests/images/PPC-Niche-Design/ready-left-img.png" class="dubai-agent">
                </div>
                <div class="col-lg-8">

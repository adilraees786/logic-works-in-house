...
$meta_title = "Adword Niche Design Temper";
...
<style>
  ...
  background-image: url('assests/images/Adword-Niche-Design/ready-bg.png');
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-8">
                    <h1 class="text-white">Grow Your Business with <span>High-Converting Google Ads</span>
                    </h1>
                    <p class="text-logo">Logic Works helps brands generate leads and sales with data-driven AdWords
                        campaigns tailored to their goals.</p>
                ...
                <div class="col-lg-4 col-md-4">
                    <img src="assests/images/Adword-Niche-Design/hero-img.png">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="ai-chatbot-project-sec hap-sec py-140" data-delay="0s"
        ...
        <div class="container">
            <div class="row dubai-row-mind align-items-center mt-0"
                ...
                <div class="col-lg-8">
                    <h2 class="text-white same-all mb-10">Ready to Scale <br>with Google Ads?</h2>

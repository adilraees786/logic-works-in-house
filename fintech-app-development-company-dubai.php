...
?>
<style>
    .fintech-app-development-company-dubai {
        overflow: hidden;
    }

    .fintech-app-development-company-dubai .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .fintech-app-development-company-dubai .section-marquee .marwuee-row:before {
        display: none;
    }

    .fintech-app-development-company-dubai .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="fintech-app-development-company-dubai bg-black">
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Fintech App Development Company Dubai
                                    &nbsp;—&nbsp;Fintech App Development Company Dubai
                                </p>
                            </div>

...
$canonical = "https://logicworks.ae/web-design-solutions-in-dubai";
        ...
        <section class="seo-hero-sec section-bg wdsd1">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <img src="assests/images/website/banner-ikmage.webp" alt="web-des-hero-img" class="bansec">
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="our-serve-slider">
                                            <img src="assests/images/website/corporate-webiste.webp"
                                                alt="web-design-slider-001">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="our-serve-slider">
                                            <img src="assests/images/website/e-website.webp"
                                                alt="web-design-slider-002">
                                            <div class="our-content-slider">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="our-serve-slider">
                                            <img src="assests/images/website/landing-page-design.webp"
                                                alt="web-design-slider-003">
                                            <div class="our-content-slider">
    ...
    <section class="section-bg port-web" id="port-web">
        <div class="container" style="display: block;">
            <div class="row slider-logo">
                <div class="col">
                    <swiper-container style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                        ...
                        <swiper-slide>
                            <img src="assests/images/website/slider-01.webp" alt="web-design-001" />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="assests/images/website/captbutch.webp" alt="web-design-002" />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="assests/images/website/Ask.webp" alt="web-design-003" />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="assests/images/website/gametimewellness.webp" alt="web-design-004" />
                        </swiper-slide>
                    </swiper-container>
                    ...
                    <swiper-container class="mySwiper2" space-between="10" slides-per-view="4" free-mode="true"
                        ...
                        <swiper-slide>
                            <img src="assests/images/website/slide-pagi-01.webp" alt="web-design-slider-001" />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="assests/images/website/slide-pagi-02.webp" alt="web-design-slider-002" />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="assests/images/website/slide-pagi-03.webp" alt="web-design-slider-003" />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="assests/images/website/slide-pagi-04.webp" alt="web-design-slider-004" />
                        </swiper-slide>
                    </swiper-container>
                </div>
            </div>
            ...
            <div class="row align-items-center transform-row">
                <div class="col-lg-4">
                    <img src="assests/images/marketing/banda.webp" class="bde">
                </div>
                <div class="col-lg-8">
                            ...
                            <div class="unique-tab-container">
                                <div id="UniqueConsultation" class="unique-tab-content" style="display: block;">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="assests/images/website/tab-img.webp" alt="tab-img-001"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="UniqueConcept" class="unique-tab-content">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                                <img src="assests/images/website/tab-img.webp" alt="tab-img-002"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="UniqueRevisions" class="unique-tab-content">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                                <img src="assests/images/website/tab-img.webp" alt="tab-img-003"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="UniqueDelivery" class="unique-tab-content">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                               <img src="assests/images/website/tab-img.webp" alt="tab-img-004"/>
                                        </div>
                                    </div>
                                </div>
                            </div>

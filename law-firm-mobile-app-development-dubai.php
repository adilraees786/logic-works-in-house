...
?>
<style>
    .law-firm-mobile-app-development-dubai {
        overflow: hidden;
    }

    .law-firm-mobile-app-development-dubai .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .law-firm-mobile-app-development-dubai .section-marquee .marwuee-row:before {
        display: none;
    }

    .law-firm-mobile-app-development-dubai .same-all {
        font-size: 50px;
        font-weight: 600;
    }
...
<main class="law-firm-mobile-app-development-dubai bg-black">
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Law Firm Mobile App Development Dubai
                                    &nbsp;—&nbsp;Law Firm Mobile App Development Dubai
                                </p>
                            </div>
    ...
    <section>
        <?php
        include("components/law-firm-about.php");
        ?>
    </section>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/law-app-images/story-img-1.webp"
                                                        alt="seo-success-001">
                                                </div>
                                                <div class="col-lg-5">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/law-app-images/story-img-2.webp"
                                                        alt="seo-success-002">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="tab-data-consultancy">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/law-app-images/story-img-3.webp"
                                                        alt="seo-success-003">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="tab-data-consultancy">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/law-app-images/story-img-4.webp"
                                                        alt="seo-success-004">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="tab-data-consultancy">

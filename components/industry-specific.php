...
<body>
    <section class="process-section bg-black">
        ...
        <div class="process-header">
            <h2>Industry-Specific Performance <br> Marketing Expertise</h2>
            <p>Targeted growth strategies for every sector</p>
        </div>
        ...
        <div class="process-grid">
            ...
            <div class="process-item item-1">
                <div class="process-overlay">
                    <div class="process-text">
                        <h3>Performance Marketing for <br> Technology Companies</h3>
            ...
            <div class="process-item item-2">
                <div class="process-overlay">
                    <div class="process-text">
                        <h3>Performance Marketing <br> Healthcare Organizations</h3>
                        <div class="highlight">Explore More</div>
                    </div>
                </div>
            </div>
            ...
            <div class="process-item item-3">
                <div class="process-overlay">
                    <div class="process-text">
                        <h3>Performance Marketing for <br> Financial Services </h3>
                        <div class="highlight">Explore More</div>
                    </div>
                </div>
            </div>
            ...
            <div class="process-item item-4">
                <div class="process-overlay">
                    <div class="process-text">
                        <h3>Performance Marketing for <br> E-commerce Businesses</h3>
                        <div class="highlight">Explore More</div>
                    </div>
                </div>
            </div>
            ...
            <div class="process-item item-5">
                <div class="process-overlay">
                    <div class="process-text">
                        <h3>Performance Marketing for <br> Professional Services</h3>
                        <div class="highlight">Explore More</div>
                    </div>
                </div>
            </div>
            ...
            <div class="process-item item-6">
                <div class="process-overlay">
                    <div class="process-text">
                        <h3>Performance Marketing for <br> Manufacturing Companies</h3>
                        <div class="highlight">Explore More</div>
                    </div>
                </div>
            </div>

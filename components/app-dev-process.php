            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="process-image">
                        <img id="processImage" src="./assests/images/ai-development/Group1.webp"
                            alt="App dev Process Image" class="fade-transition show">
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="text-center">
                        <h2 class="section-title-8">Our Process</h2>
                        <p class="section-subtitle-6">How We Bring AI to Life</p>
                    </div>
...
<script>
    ...
    const tabData = {
        discovery: {
            image: './assests/images/ai-development/Group1.webp',

            ...
            <div class="content-section mt-30">
                <div class="tabs-container">
                    <div class="tab-item active" data-tab="trust">
                        <h3 class="tab-title">Localized Ad Targeting</h3>
                    ...
                    <div class="tab-item" data-tab="conversions">
                        <h3 class="tab-title">AI-Powered Campaigns</h3>
                        <div class="tab-content">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                            laboris nisi ut aliquip ex ea commodo consequat.
                    ...
                    <div class="tab-item" data-tab="seo">
                        <h3 class="tab-title">E-commerce & Lead Generation</h3>
                        <div class="tab-content">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                            laboris nisi ut aliquip ex ea commodo consequat.
                ...
                <div class="image-container">
                    <div class="image-wrapper">
                        <img src="assests/images/fb-insta-ads/scroll-img.webp" class="tab-image active" id="trust-image"
                            alt="Trust">
                        <img src="assests/images/fb-insta-ads/scroll-img.webp" class="tab-image" id="conversions-image"
                            alt="Conversions">
                        <img src="assests/images/fb-insta-ads/scroll-img.webp" class="tab-image" id="seo-image"
                            alt="SEO">
                        <img src="assests/images/fb-insta-ads/scroll-img.webp" class="tab-image" id="branding-image"
                            alt="Branding">
                        <img src="assests/images/fb-insta-ads/scroll-img.webp" class="tab-image" id="reputation-image"
                            alt="Reputation">
                    </div>

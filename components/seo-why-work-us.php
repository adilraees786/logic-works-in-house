...
<body>
    <div class="container">
        <div>
            <h2 class="why-android-title">Why Choose Logic Works for SEO Consultancy?</h2>
            <p class="why-android-subtitle">Trusted SEO consultancy focused on growth, clarity, and measurable business
                outcomes.</p>
                ...
                <div class="col-lg-5">
                    <div class="side-card" onclick="updateMainCard(0)">
                        ...
                        <div class="side-card-body">
                            <div class="side-card-title">Data-Driven Strategies</div>
                            <div class="side-card-text">We rely on data and research to guide our SEO work, ensuring
                                growth is steady and real.</div>
                        </div>
                    </div>
                    <div class="side-card" onclick="updateMainCard(1)">
                        <img src="assests/images/branding-dubai/seo-img-2.webp" alt="" />
                        <div class="side-card-body">
                            <div class="side-card-title">Customized Plans for Every Business</div>
                            <div class="side-card-text">Our team builds strategies around your business goals, creating
                                SEO plans that match your industry and growth.</div>
                        </div>
                    </div>
                    <div class="side-card" onclick="updateMainCard(2)">
                        <img src="assests/images/branding-dubai/seo-img-3.webp" alt="" />
                        <div class="side-card-body">
                            <div class="side-card-title">Transparent Reporting & Measurable Results</div>
                            <div class="side-card-text">We provide open reports that show rankings, traffic, and
                                conversions, so you always know where you stand.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="main-card" id="mainCard">
                        ...
                        <div class="main-card-body">
                            <div class="main-card-title" id="mainCardTitle">Data-Driven Strategies</div>
                            <div class="main-card-text" id="mainCardText">We rely on data and research to guide our SEO
                                work, ensuring growth is steady and real.</div>
        ...
        const services = [
            {
                ...
                text: "We rely on data and research to guide our SEO work, ensuring growth is steady and real.",
                img: "assests/images/branding-dubai/seo-img-1.webp"
            },
            {
                title: "Customized Plans for Every Business",
                text: "Our team builds strategies around your business goals, creating SEO plans that match your industry and growth.",
                img: "assests/images/branding-dubai/seo-img-2.webp"
            },
            {
                title: "Transparent Reporting & Measurable Results",
                text: "We provide open reports that show rankings, traffic, and conversions, so you always know where you stand.",

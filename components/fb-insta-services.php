...
<body>
    <div class="container d-block pb-50">
        <div class="">
            <p class="main-title">Our Facebook Marketing <br> Services</p>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="main-card" id="mainCard">
                    <img src="assests/images/fb-instagram-marketingt/service-image-1.webp" id="mainCardImg"
                        alt="Service Image">
                    <div class="main-card-body">
                        <div class="main-card-title" id="mainCardTitle">Campaign Strategy Development</div>
                        <div class="main-card-text" id="mainCardText">
                            Research-backed plans identifying ideal audiences, messaging angles, and conversion paths
                            for business goals.
                        </div>
        ...
        const services = [
            {
                ...
                img: "assests/images/fb-instagram-marketingt/service-image-1.webp",
                btn: "READ MORE",
                text: "Research-backed plans identifying ideal audiences, messaging angles, and conversion paths for business goals."
            },
            {
                title: "Creative Content Production",
                img: "assests/images/fb-instagram-marketingt/service-image-2.webp",
                btn: "READ MORE",
                text: "High-performing ad visuals and copy tested for engagement that stops scrolling and drives clicks."
            },
            {
                title: "Audience Targeting Optimization",
                img: "assests/images/fb-instagram-marketingt/service-image-3.webp",
                btn: "READ MORE",
                text: "Advanced segmentation using demographics, interests, behaviors, and custom audiences for precise reach."
            },
            {
                title: "Conversion Campaign Management",
                img: "assests/images/fb-instagram-marketingt/service-image-1.webp",
                btn: "READ MORE",
                text: "Sales-focused ad sets structured to guide prospects from awareness through purchase decisions."
            },
            {
                title: "Retargeting Strategy Implementation",
                img: "assests/images/fb-instagram-marketingt/service-image-2.webp",
                btn: "READ MORE",
                text: "Sequential messaging campaigns that re-engage website visitors and convert abandoned shopping carts."
            }
        ];

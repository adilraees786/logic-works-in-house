...
<kamis>
    ...
    <h2 class="why-choice-dmad fs-44 fw-900">WHY CHOOSE US</h2>
    ...
    <div class="slider-container">
        ...
        <div class="slider-wrapper">
            <div class="slide left-slide">
                <img src="assests/images/digital-marketing-agency-dubai/right-img.webp" alt="side-img-00">
            </div>

            <div class="slide center-slide" id="center-slide">
                <img src="assests/images/digital-marketing-agency-dubai/img-1.webp" alt="didgi-mar-agn-ae">
                <div class="info">
            ...
            <div class="slide right-slide">
                <img src="assests/images/website-designer/img-2.webp" alt="side-img-002">
            </div>
        </div>
    ...
    <script>
        ...
        const slidesData = [
            {
                img: "assests/images/digital-marketing-agency-dubai/img-2.webp",

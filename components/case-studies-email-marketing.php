    ...
    <div class="container py-5">
        <div>
            ...
            <div class="d-flex justify-content-end">
                <button id="prevBtn-email" class="btn  me-2"><img src="assests/images/arrow-left.png" alt=""></button>
                <button id="nextBtn-email" class="btn "><img src="assests/images/arrow-right.png" alt=""></button>
            </div>
        </div>
    </div>

            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="process-image">
                        <img id="processImage" src="assests/images/website-designer/process-img.jpg" alt="Process Image"
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="text-center">
                        <h2 class="section-title-8">Design Process</h2>
                        <p class="section-subtitle-6">A Simple, Streamlined <br>Workflow</p>
                    </div>
                    <div class="process-content">
                        <div id="contentArea">
                            <h3 class="content-title">Discovery Call</h3>
                    ...
                    <div class="process-tabs">
                        <div class="tab-item active" data-tab="discovery">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="tab-title">Discovery Call</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-item" data-tab="analysis">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="tab-title">Wireframing & Prototyping</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-item" data-tab="development">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="tab-title">Visual Design & Development</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-item" data-tab="testing">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="tab-title">Revisions & Feedback</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-item" data-tab="deployment">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="tab-title">Launch & Optimization</h4>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    const tabData = {
        discovery: {
            image: 'assests/images/website-designer/process-img.jpg',

...
$canonical = "https://logicworks.ae/network-security";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is network security and why is it needed?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Network security protects your systems and data from attacks, unauthorized access, and misuse. It keeps your business running smoothly by reducing risks and blocking harmful threats."
    }
  },{
    "@type": "Question",
    "name": "How often should vulnerability scans be done?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Vulnerability scans should be done every month or after any system updates. Regular scans help catch issues early and reduce the chance of data loss."
    }
  },{
    "@type": "Question",
    "name": "Does network security protect cloud storage too?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, network security includes tools that protect cloud systems. It secures your stored data and keeps access limited to trusted users."
    }
  },{
    "@type": "Question",
    "name": "Can network and security systems scale with business growth?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, modern network and security setups are designed to grow with your business. They can handle more users, data, and traffic without losing protection."
    }
  }]
}
</script>
...
<style>
  ...
  @media (max-width: 500px) {
    ...
    .newtwork-security-page .seo-btn {
      display: flex;
      margin-top: 10px;
    }
...
<main class="newtwork-security-page bg-black">
  ...
  <div class="position-relative section-bg-wrapper overflow-hidden z-1">
    ...
    <section class="wwo-sec">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h2 class="network-heading text-white text-center fs-59 fw-900">Our Approach to Network Security</h2>
          ...
          <div class="wwo-slider">
            <div style=" padding: 10rem 0.1rem 0.1rem 0.1rem;" class="col-lg-4 col-6">
              <div style=" height: 100%; padding: 10rem 0.1rem 0.1rem 0.1rem;"
                ...
                <img src="assests/images/network-security/wwo-img-01.webp" alt="wwo-1" class="img-fluid">
            ...
            <div style=" padding: 10rem 0.1rem 0.1rem 0.1rem;" class="col-lg-4 col-6">
              <div style=" height: 100%; padding: 10rem 0.1rem 0.1rem 0.1rem;"
                class="wwo-card overflow-hidden position-relative">
                <img src="assests/images/network-security/wwo-img-03.webp" alt="wwo-2" class="img-fluid">
                <div style="position: relative;  background-color: black;">
                  <div class="text-overlay ">
                    <h4 style="color: white; font-weight: 900; font-size: 40px; ;"
                      class="d-flex text-center flex-column justify-content-center align-items-center">
            ...
            <div style=" padding: 10rem 0.1rem 0.1rem 0.1rem;" class="col-lg-4 col-6">
              <div style=" height: 100%; padding: 10rem 0.1rem 0.1rem 0.1rem;"
                class="wwo-card overflow-hidden position-relative">
                <img src="assests/images/network-security/sep-image.webp" alt="wwo-1" class=""
            ...
            <div style=" padding: 10rem 0.1rem 0.1rem 0.1rem;" class="col-lg-4 col-6">
              <div style=" height: 100%; padding: 10rem 0.1rem 0.1rem 0.1rem;"
                class="wwo-card overflow-hidden position-relative">
                <img src="assests/images/network-security/wwo-img-03.webp" alt="wwo-1" class="img-fluid">
                <div style="position: relative;  background-color: black;">
                  <div class="text-overlay ">
                    <h4 style="color: white; font-weight: 900; font-size: 40px; ;"
                      class="d-flex text-center flex-column justify-content-center align-items-center">
    ...
    <section class="ai-chatbot-project-sec hap-sec py-140" data-delay="0s"
      ...
      <div class="container">
        <div class="row dubai-row-mind align-items-center mt-0" style="background-color: #59249A; border-radius: 30px;">
          <div class="col-lg-4">
            <img src="assests/images/network-security/hap-left.webp" alt="women-agenet" class="dubai-agent">
          </div>
          <div class="col-lg-8">
  ...
  <section class="network-security-wcu section-bg">
    <div class="row">
      <div class="col-lg-6 p-0">
        <img src="./assests/images/network-security/wcu-left.webp" alt="wcu-left-img">
      </div>
      <div class="col-lg-6 p-0">
        <div class="wcu-right-area py-100 px-100 h-100">
          <h2 class="Question-heading text-white text-uppercase fs-47 fw-900 mb-20">Why Choose Logic Works for Network
            Security?</h2>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="security-matters-left-content">
          <h2 class="why-choice-network fs-60 fw-900 text-white mb-40">Why Your Business Needs Network Protection</h2>
      ...
      <div class="col-lg-6">
        <img src="./assests/images/network-security/security-matters-right.webp" aria-label="security-matters"
          class="security-matters-right" alt="security-matters-img">
      </div>
    </div>
  </section>
  <section class="about-ads py-100 section-bg">
    <div class="row align-items-center mt-0 transform-row about-ads-bg">
      <div class="col-lg-4">
        <img src="assests/images/marketing/banda.webp" alt="network-banda">
      </div>
      <div class="col-lg-8">

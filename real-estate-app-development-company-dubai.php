...
<style>
    ...
    .app-development-niche-design .ai-chatbot-project-sec .dubai-row-mind {
        background-image: url('./assests/images/app-development-niche-design/ready-bg.webp');
...
<main class="app-development-niche-design bg-black">
    ...
    <section class="ai-chatbot-project-sec hap-sec py-20" data-delay="0s"
        ...
        <div class="container">
            <div class="row dubai-row-mind align-items-center mt-0"
                ...
                <div class="col-lg-8">
                    <h2 class="text-white same-all mb-10 ml-20">Ready to Scale <br>with Google Ads?</h2>

                    <a href="#" class="ml-20">Request a Quote</a>
                </div>
                <div class="col-lg-4">
                    <img src="./assests/images/app-development-niche-design/right-image.webp" alt="cta-app-nich-img"
                        style="max-width: 350px;" class="dubai-agent">
                </div>
            </div>
        </div>
    </section>
    <section>
        <?php
        include("components/app-dev-services-niche.php");
        ?>
    </section>
    <section>
        <?php
        include("components/app-dev-process.php");
        ?>
    </section>
    <section class="">
        ...
        <div class="row align-items-center transform-row">
            <div class="col-lg-4">
                <img src="./assests/images/marketing/banda.webp" alt="banda-img-app-dec-nich" class="gta">
            </div>
            <div class="col-lg-8">

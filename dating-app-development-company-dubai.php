    ...
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <img src="./assests/images/app-development-niche-design/dating-app.webp" alt="app-dev-niche-hero-img">
                </div>
            </div>
        </div>
    </section>
...
<style>
    ...
    .dating-app-development-company-dubai .consultancy-hero-sec .col-lg-4 {
        display: flex;

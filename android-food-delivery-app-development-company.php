<?php
$meta_title = "Android Food Delivery App Development Company | Logic Works";
...
$keyword = 'Android Healthcare App Development Company';
$canonical = "https://logicworks.ae/android-food-delivery-app-development-company";
include("includes/head.php");
include("includes/header.php");
?>
<style>
    .android-food-delivery-app-development-company {
        overflow: hidden;
    }

    .android-food-delivery-app-development-company .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .android-food-delivery-app-development-company .section-marquee .marwuee-row:before {
        display: none;
    }

    .android-food-delivery-app-development-company .same-all {
        font-size: 50px;
        font-weight: 600;
    }

    .android-food-delivery-app-development-company .consultancy-hero-sec .col-lg-4 {
        display: flex;
...
<main class="android-food-delivery-app-development-company bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white">Android <span>Food Delivery</span> App Development Company</span>
                    </h1>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Android Food Delivery App Development Company
                                    &nbsp;—&nbsp;Android Food Delivery App Development Company
                                </p>
                            </div>
...
<style>
    ...
    /* .android-education-app-development-company .consultancy-hero-sec .col-lg-4 {
        display: flex;
        justify-content: center;
    } */

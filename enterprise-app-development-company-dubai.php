...
<style>
    ...
    .enterprise-app-development-company-dubai .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .enterprise-app-development-company-dubai .section-marquee .marwuee-row:before {
        display: none;
    }

    .enterprise-app-development-company-dubai .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="enterprise-app-development-company-dubai bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <img src="./assests/images/enterprise-app/hero-img.webp" alt="app-dev-enterprise-hero-img">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Enterprise App Development Company Dubai
                                    &nbsp;—&nbsp;Enterprise App Development Company Dubai
                                </p>
                            </div>
    ...
    <section class="section-bg app-port-sec" style="background-image: url(assests/images/serice-bg.webp);">
        <div class="container" style="display: block; padding-top: 50px;">
            <div class="row">
                <div class="col">
                    <h2 class="text-white text-center same-all">Our <span>Enterprise App</span> Portfolio</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="app-portfolio-img">
                        <img src="assests/images/enterprise-app/portfolio-01.webp" alt="portfolio-img-001">
                        <img src="assests/images/enterprise-app/portfolio-02.webp" alt="portfolio-img-002">
                        <img src="assests/images/enterprise-app/portfolio-03.webp" alt="portfolio-img-003">
                        <img src="assests/images/enterprise-app/portfolio-04.webp" alt="portfolio-img-004">
                        <img src="assests/images/enterprise-app/portfolio-05.webp" alt="portfolio-img-005">
                        <img src="assests/images/enterprise-app/portfolio-06.webp" alt="portfolio-img-006">
                        <img src="assests/images/enterprise-app/portfolio-07.webp" alt="portfolio-img-007">
                        <img src="assests/images/enterprise-app/portfolio-08.webp" alt="portfolio-img-006">
                        <img src="assests/images/enterprise-app/portfolio-09.webp" alt="portfolio-img-009">
                        <img src="assests/images/enterprise-app/portfolio-10.webp" alt="portfolio-img-0010">
                        <img src="assests/images/enterprise-app/portfolio-11.webp" alt="portfolio-img-0011">
                        <img src="assests/images/enterprise-app/portfolio-12.webp" alt="portfolio-img-0012">
                    </div>
                </div>
                <div class="col-lg-3">
                    <img src="assests/images/enterprise-app/portfolio-13.webp" alt="portfolio-img-13">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-bg app-dubai-services">
        <div class="container">
            <div class="row dubai-tabs-row">
                <div class="col-lg-6">
                    <img src="./assests/images/enterprise-app/tab-image.webp" alt="tab-img-app-dev">
                </div>
                <div class="col-lg-6">
...
<style>
    ...
    .enterprise-app-development-company-dubai .consultancy-hero-sec .col-lg-4 {
        display: flex;

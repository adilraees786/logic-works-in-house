...
$canonical = "https://logicworks.ae/fb-instagram-marketing";
$custom_schema = '
...
<main class="fb-instagram-marketing-page bg-black">
    <section class="blur-bg section-bg digital-main" id="portfolio-hero"
        style="background-image: url('assests/images/fb-instagram-marketingt/hero-bg.webp'); background-repeat: no-repeat; background-position: center; background-size: cover;">

        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-12">
                    <h1 class="text-white-hero-1"><span class="fb-heading fs-28 fw-700">Scale Your Sales with</span>
                        Strategic Facebook & Instagram Marketing Agency Expertise</h1>
                    <p class="text-white-hero">Turn Followers into Customers with Targeted Social Media Campaigns
                    </p>
                    <p class="text-white">Social media advertising presents real challenges for growing businesses.
                        Budgets disappear quickly when ads reach the wrong audience or fail to convert viewers into
                        buyers. Companies struggle with changing algorithms, audience targeting, and creative content
                        that actually sells. Our Facebook and instagram marketing agency removes these roadblocks. Our
                        campaigns are built around the audience behavior and conversion strategy. We advertise in
                        Facebook and Insta where we smart target actual buyers. Campaigns are reviewed on a daily basis
                        and enhanced where necessary and aimed at generating sales and consistent growth.
                    </p>
                    <?php
                    include("components/fb-insta-list.php");
                    ?>
    ...
    <section class="bg-black"
        ...
        <?php
        include("components/why-choice-fb-insta.php");
        ?>
    </section>
    <section class="">
        <?php
        include("components/faccebook-insta-how-we-work.php");
        ?>
    </section>
    <section class=""
        style="background-image: url('assests/images/serice-bg.webp');  background-size: cover; background-repeat: no-repeat; ">
        <?php
        include("components/fb-insta-services.php");
        ?>
    </section>

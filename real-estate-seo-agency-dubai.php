...
$keyword = 'Seo Niche Design';
$canonical = "http://localhost//logic-works/real-estate-seo-agency-dubai";
include("includes/head.php");
include("includes/header.php");
?>
<style>
    .seo-niche-design .section-marquee .marwuee-row:before {
        display: none;
    }
</style>
<main class="seo-niche-design bg-black">
    <section class="consultancy-hero-sec section-bg bg-black"
        style="background-image: url('assests/images/seo-niche-design/hero-bg.webp'); background-size: cover; background-position: center; background-repeat: no-repeat;">

        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-12">
                    <h1 class="text-white">Turn Clicks Into Clients With SEO That Delivers.</h1>
                    <p class="text-white"> At Logic Works, we don’t just optimize for search engines—we  optimize
                        for
                        business growth.</p>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Smarter Visibility. Measurable Growth.&nbsp;—&nbsp;Smarter
                                    Visibility. Measurable Growth.</p>
                            </div>
                            <span class="marquee__separator"><img src="assests/images/branding-dubai/Star.png"></span>
                            <div class="marquee__item">
                                <p class="marquee__text">Smarter Visibility. Measurable Growth.</p>
                            </div>
                            <span class="marquee__separator"><img src="assests/images/branding-dubai/Star.png"></span>
                            <div class="marquee__item">
                                <p class="marquee__text">Smarter Visibility. Measurable Growth.</p>
    ...
    <section>
        <?php
        include("components/why-seo-matters-niche.php");
        ?>
    </section>
    <section>
        <?php
        include("components/seo-niche-services.php");
        ?>
    </section>
    <section>
        <?php
        include("components/why-choice-logic-seo-niche.php");
        ?>
    </section>
    <section>
        <?php
        include("components/seo-ready-toget.php");
        ?>
    </section>

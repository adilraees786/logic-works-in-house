<?php
$meta_title = "Android Healthcare App Development Company | Logic Works ";
...
?>
<style>
    .android-health-care-app-development-company .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .android-health-care-app-development-company .section-marquee .marwuee-row:before {
        display: none;
    }

    .android-health-care-app-development-company .same-all {
        font-size: 50px;
        font-weight: 600;
    }

    .android-health-care-app-development-company .app-bg h3 {
        text-align: center;
        color: #fff;
        font-size: 17px;
        font-weight: 700;
...
<main class="android-health-care-app-development-company bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white">Android <span>Healthcare App</span> Development Company </span>
                    </h1>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Android Healthcare App Development Company
    ...
    <section>
        <?php
        include("components/health-care-app-dev-about.php");
        ?>
    </section>
...
<style>
    ...
    .android-health-care-app-development-company .consultancy-hero-sec .col-lg-4 {
        display: flex;
        justify-content: center;
    }

...
<main>
  <section class="blog-hero-sec section-bg"
    style="background-image:url(assests/images/blog/blog-bg.webp); background-repeat: no-repeat; background-size: cover; background-position: top center;">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
            ...
            <div class="swiper blog-slidrrr">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <a href="#">
                    <img src="assests/images/blog/caroual-blog-1.webp" alt="blog-caroual-001">
                ...
                <div class="swiper-slide">
                  <a href="#">
                    <img src="assests/images/blog/caroual-blog-2.webp" alt="blog-caroual-002">
                    <div class="horrific-content">
                      <h2 class="text-white">How He Has Found Peace During This Horrific</h2>
                      <p class="post-author">By: Maheen Sabeeh</p>
                      <p class="post-date-slider">Sep 18, 2024</p>
                ...
                <div class="swiper-slide">
                  <a href="#">
                    <img src="assests/images/blog/caroual-blog-3.webp" alt="blog-caroual-003">
                    <div class="horrific-content">
                      <h2 class="text-white">How He Has Found Peace During This Horrific</h2>
                      <p class="post-author">By: Maheen Sabeeh</p>
                      <p class="post-date-slider">Sep 18, 2024</p>
                ...
                <div class="swiper-slide">
                  <a href="#">
                    <img src="assests/images/blog/caroual-blog-1.webp" alt="blog-caroual-004">
                    <div class="horrific-content">
                      <h2 class="text-white">How He Has Found Peace During This Horrific</h2>
                      <p class="post-author">By: Maheen Sabeeh</p>
                      <p class="post-date-slider">Sep 18, 2024</p>
                ...
                <div class="swiper-slide">
                  <a href="#">
                    <img src="assests/images/blog/caroual-blog-2.webp" alt="blog-caroual-005">
                    <div class="horrific-content">
                      <h2 class="text-white">How He Has Found Peace During This Horrific</h2>
                      <p class="post-author">By: Maheen Sabeeh</p>
                      <p class="post-date-slider">Sep 18, 2024</p>
                ...
                <div class="swiper-slide">
                  <a href="#">
                    <img src="assests/images/blog/caroual-blog-3.webp" alt="blog-caroual-006">
                    <div class="horrific-content">
                      <h2 class="text-white">How He Has Found Peace During This Horrific</h2>
                      <p class="post-author">By: Maheen Sabeeh</p>
                      <p class="post-date-slider">Sep 18, 2024</p>
  ...
  <section class="section-bg blogs-all" style="background-image:url(assests/images/serice-bg.webp);">
    <div class="container" style="display: block;">
      ...
      <div class="row">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-01.webp" alt="blog-post-001">
          </div>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-02.webp" alt="blog-post-002">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
      ...
      <div class="row post-row-last">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-03.webp" alt="blog-post-003">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-04.webp" alt="blog-post-004">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
    ...
    <div class="container" style="display: block;">
      ...
      <div class="row">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-05.webp" alt="blog-post-005">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-06.webp" alt="blog-post-006">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
      ...
      <div class="row post-row-last">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-07.webp" alt="blog-post-007">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-08.webp" alt="blog-post-008">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
    ...
    <div class="container" style="display: block;">
      ...
      <div class="row">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-09.webp" alt="blog-post-009">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-10.webp" alt="blog-post-0010">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
      ...
      <div class="row post-row-last">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-11.webp" alt="blog-post-0011">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-12.webp" alt="blog-post-0012">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
    ...
    <div class="container" style="display: block;">
      ...
      <div class="row">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-13.webp" alt="blog-post-0013">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-14.webp" alt="blog-post-0014">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
      ...
      <div class="row post-row-last">
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-15.webp" alt="blog-post-0015">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col-lg-6" style="display:flex; gap: 20px;">
          <div class="blog-img-tab">
            <img src="assests/images/blog/post-16.webp" alt="blog-post-0016">
          </div>
          <div class="blog-content-tab">
            <p class="post-date text-white">Posted on October 19, 2024</p>
        ...
        <div class="col">
          <div class="swiper centered-mode-slider">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Logo-Design-carfting.webp" alt="blog-sto-001">
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Social-media-marketing.webp" alt="blog-sto-002">
                  <h6>Paul Scanion <span>wrote</span></h6>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/SEo.webp" alt="blog-sto-003">
                  <h6>Paul Scanion <span>wrote</span></h6>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Logo-Design-carfting.webp" alt="blog-sto-004">
                  <h6>Paul Scanion <span>wrote</span></h6>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Logo-Design-carfting.webp" alt="blog-sto-005">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">Logo Design: Crafting the and Identity</h4>
                  <p class="text-white">ch more than a simple image or text. It e face of a brand, conveying its values,
                    identity in an instant. Whether you're new business or rebranding an existing ng an effective logo
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Social-media-marketing.webp" alt="blog-sto-006">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">Social Media Marketing</h4>
                  <p class="text-white">Promoting your brand through platforms like Face-book, Instagram, Twitter, and
                    Linkedin to reach and interact with your audience.</p>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/SEo.webp" alt="blog-sto-007">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">On-Page Optimization</h4>
                  <p class="text-white">Enhancing individual pages by optimizing titles, meta descriptions, headers, and
                    images for better rankings.</p>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Logo-Design-carfting.webp" alt="blog-sto-008">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">How To Build Custom Data Using Luzmo Flex</h4>
                  <p class="text-white">Bringing data to life in your applica without the usual headaches. Pau you how
                    you can build beautiful da using the Google Analytics API, an to spend any time "massaging" th a
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Logo-Design-carfting.webp" alt="blog-sto-009">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">Logo Design: Crafting the and Identity</h4>
                  <p class="text-white">ch more than a simple image or text. It e face of a brand, conveying its values,
                    identity in an instant. Whether you're new business or rebranding an existing ng an effective logo
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Social-media-marketing.webp" alt="blog-sto-0010">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">Social Media Marketing</h4>
                  <p class="text-white">Promoting your brand through platforms like Face-book, Instagram, Twitter, and
                    Linkedin to reach and interact with your audience.</p>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/SEo.webp" alt="blog-sto-0011">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">On-Page Optimization</h4>
                  <p class="text-white">Enhancing individual pages by optimizing titles, meta descriptions, headers, and
                    images for better rankings.</p>
              ...
              <div class="swiper-slide">
                <div class="col">
                  <img src="assests/images/service/Logo-Design-carfting.webp" alt="blog-sto-0012">
                  <h6>Paul Scanion <span>wrote</span></h6>
                  <h4 class="text-white">How To Build Custom Data Using Luzmo Flex</h4>
                  <p class="text-white">Bringing data to life in your applica without the usual headaches. Pau you how
                    you can build beautiful da using the Google Analytics API, an to spend any time "massaging" th a
  ...
  <section class="section-bg pt-b-150 journey-sec" id="project-in-minds">
    <div class="container">
      <div class="row justify-content-space-between project-in-mind"
        ...
        <div class="col-lg-6 col-md-6">
          <img src="assests/images/Get-Website.webp" alt="blog-cta">
        </div>
      </div>
    </div>
  </section>

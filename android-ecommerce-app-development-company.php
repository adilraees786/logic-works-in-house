<?php
$meta_title = "Android Ecommerce App Development Company | Logic Works";
...
$keyword = 'Android Ecommerce App Development Company';
$canonical = "https://logicworks.ae/android-ecommerce-app-development-company";
$faq_data = '
...
<style>
    ...
    .android-ecommerce-app-development-company .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }

    .android-ecommerce-app-development-company .section-marquee .marwuee-row:before {
        display: none;
    }

    .android-ecommerce-app-development-company .same-all {
        font-size: 50px;
        font-weight: 600;
    }
    ...
    @media (max-width: 981px) {
        .android-ccommerce-app-development-company .service-hero-sec {
            padding-top: 10px !important;
            padding-bottom: 10px !important;
        }
    }
</style>
<main class="android-ecommerce-app-development-company bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="text-white">Android <span>Ecommerce App</span> Development Company </span>
                    </h1>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Android Ecommerce App Development Company
                                    &nbsp;—&nbsp;Android Ecommerce App Development Company
                                </p>
                            </div>
    ...
    <section>
        <?php
        include("components/anddroid-ecommerce-about.php");
        ?>
    </section>
                                    ...
                                    <div class="service-item__img">
                                        <div class="img-wrapper">
                                            ...
                                            <img class="" data-class="lazy-img"
                                                data-src="assests/images/android-ecommerce-app-development-company/img-001.webp"
                                                alt="andrpid-app-img-001"
                                                src="assests/images/android-ecommerce-app-development-company/img-001.webp">
                            ...
                            <div class="service-item twocol-row">
                                <div class="service-item__wrapper twocol-row">
                                    <div class="service-item__img">
                                        <div class="img-wrapper">
                                            <img class="" data-class="lazy-img"
                                                data-src="assests/images/android-ecommerce-app-development-company/img-002.webp"
                                                alt="andrpid-app-img-001"
                                                src="assests/images/android-ecommerce-app-development-company/img-002.webp">
                            ...
                            <div class="service-item twocol-row">
                                <div class="service-item__wrapper twocol-row">
                                    <div class="service-item__img">
                                        <div class="img-wrapper">
                                            <img class="" data-class="lazy-img"
                                                data-src="assests/images/android-ecommerce-app-development-company/img-003.webp"
                                                alt="andrpid-app-img-001"
                                                src="assests/images/android-ecommerce-app-development-company/img-003.webp">
                            ...
                            <div class="service-item twocol-row">
                                <div class="service-item__wrapper twocol-row">
                                    <div class="service-item__img">
                                        <div class="img-wrapper">
                                            <img class="" data-class="lazy-img"
                                                data-src="assests/images/android-ecommerce-app-development-company/img-004.webp"
                                                alt="brading-dev-img"
                                                src="assests/images/android-ecommerce-app-development-company/img-004.webp">
    ...
    <section class="section-bg app-dubai-services">
        <div class="container">
            <div class="row dubai-tabs-row">
                <div class="col-lg-6">
                    <img src="assests/images/android-ecommerce-app-development-company/ser-img.webp" alt="tab-img-app-dev">
                </div>
                <div class="col-lg-6">
...
<style>
    ...
    .android-ecommerce-app-development-company .consultancy-hero-sec .col-lg-4 {
        display: flex;

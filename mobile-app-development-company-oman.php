...
<style>
    ...
    .mobile-app-development-company-Oman .service-hero-sec {
        padding-top: 0px;
        padding-bottom: 50px;
    }
    ...
    .mobile-app-development-company-Oman .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="mobile-app-development-company-Oman bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <img src="./assests/images/mobile-app-development-company-oman/hero-img.webp"
    ...
    <section>
        <?php
        include("components/oman-mobile-app-about.php");
        ?>
    </section>
...
<style>
    ...
    /* .mobile-app-development-company-Oman .consultancy-hero-sec .col-lg-4 {
        display: flex;

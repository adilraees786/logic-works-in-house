...
?>
<style>
    .automotive-app-development-company-dubai {
        overflow: hidden;
    }
    ...
    .automotive-app-development-company-dubai .section-marquee .marwuee-row:before {
        display: none;
    }

    .automotive-app-development-company-dubai .same-all {
        font-size: 45px;
        font-weight: 600;
    }
...
<main class="automotive-app-development-company-dubai bg-black">
    <section class="consultancy-hero-sec section-bg">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <img src="./assests/images/automotive-app-images/hero-img.webp" alt="app-automative-niche-hero-img">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="marquee">
                        <div class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Automotive App Development Company Dubai
                                    &nbsp;—&nbsp;Automotive App Development Company Dubai
                                </p>
                            </div>
                        ...
                        <div aria-hidden="true" class="marquee__row">
                            <div class="marquee__item">
                                <p class="marquee__text">Automotive App Development Company Dubai
                                    &nbsp;—&nbsp;Enterprise App Development Company Dubai
                                </p>
                            </div>
                            <span class="marquee__separator"><img src="assests/images/service/Star.webp"
                                    alt="Star-4"></span>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="app-portfolio-img">
                        <img src="assests/images/automotive-app-images/portfolio-01.webp" alt="portfolio-automotive-img-001">
                        <img src="assests/images/automotive-app-images/portfolio-02.webp" alt="portfolio-automotive-img-002">
                        <img src="assests/images/automotive-app-images/portfolio-03.webp" alt="portfolio-automotive-img-003">
                        <img src="assests/images/automotive-app-images/portfolio-04.webp" alt="portfolio-automotive-img-004">
                        <img src="assests/images/automotive-app-images/portfolio-05.webp" alt="portfolio-automotive-img-005">
                        <img src="assests/images/automotive-app-images/portfolio-06.webp" alt="portfolio-automotive-img-006">
                        <img src="assests/images/automotive-app-images/portfolio-07.webp" alt="portfolio-automotive-img-007">
                        <img src="assests/images/automotive-app-images/portfolio-08.webp" alt="portfolio-automotive-img-006">
                        <img src="assests/images/automotive-app-images/portfolio-09.webp" alt="portfolio-automotive-img-009">
                        <img src="assests/images/automotive-app-images/portfolio-10.webp" alt="portfolio-automotive-img-0010">
                        <img src="assests/images/automotive-app-images/portfolio-11.webp" alt="portfolio-automotive-img-0011">
                        <img src="assests/images/automotive-app-images/portfolio-12.webp" alt="portfolio-automotive-img-0012">
                    </div>
                </div>
                <div class="col-lg-3">
                    <img src="assests/images/automotive-app-images/portfolio-13.webp" alt="portfolio-automotive-img-13">
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/automotive-app-images/story-img-1.webp"
                                                        alt="seo-success-001">
                                                </div>
                                                <div class="col-lg-5">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/automotive-app-images/story-img-2.webp"
                                                        alt="seo-success-002">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="tab-data-consultancy">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/automotive-app-images/story-img-3.webp"
                                                        alt="seo-success-003">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="tab-data-consultancy">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        <div class="consultancy-tab-content">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    <img src="assests/images/automotive-app-images/story-img-4.webp"
                                                        alt="seo-success-004">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="tab-data-consultancy">
...
<style>
    ...
    .automotive-app-development-company-dubai .consultancy-hero-sec .col-lg-4 {
        display: flex;
